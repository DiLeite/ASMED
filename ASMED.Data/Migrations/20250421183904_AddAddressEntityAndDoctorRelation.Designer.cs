...
namespace ASMED.Data.Migrations
{
    ...
    [Migration("20250421183904_AddAddressEntityAndDoctorRelation")]
    partial class AddAddressEntityAndDoctorRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASMED.Domain.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ASMED.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ASMED.Domain.Entities.Doctor", b =>
                {
                    b.HasOne("ASMED.Domain.Entities.Address", "Address")
                        .WithOne("Doctor")
                        .HasForeignKey("ASMED.Domain.Entities.Doctor", "AddressId")
            ...
            modelBuilder.Entity("ASMED.Domain.Entities.Patient", b =>
                {
                    b.HasOne("ASMED.Domain.Entities.Address", "Address")
                        .WithOne("Patient")
                        .HasForeignKey("ASMED.Domain.Entities.Patient", "AddressId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ASMED.Domain.Entities.ApplicationUser", null)
                        .WithMany()
